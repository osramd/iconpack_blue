...
public class MainAdapter extends BaseAdapter{
	...
	public View getView(int position, View v, ViewGroup parent) {
		...
		if (v == null) {
			 ...
			 */
			Typeface tfTitle = Typeface.createFromAsset(context.getAssets(),"GothamBook.ttf");
			Typeface tfDescription = Typeface.createFromAsset(context.getAssets(),"GothamBook.ttf");
